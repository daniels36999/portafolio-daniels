function iconosSvg(iconName: string) {
   ...
   const svg_email2 = (
    ...
    const svg_analisis= (
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-device-analytics" width="44" height="44" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#2c3e50" fill="none" strokeLinecap="round" strokeLinejoin="round">
        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
    ...
    const svg_multimetro= (
        <svg id="Layer_1" height="512" viewBox="0 0 24 24" width="512" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" stroke="#000000" fill="none">
...
const svg_web2= (
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 64 64">
        <linearGradient id="cX29ZNhDlWZrvi4huKePza_79062_gr1" x1="32" x2="32" y1="8.375" y2="54.627" gradientUnits="userSpaceOnUse" spreadMethod="reflect"><stop offset="0" stopColor="#1a6dff"></stop><stop offset="1" stopColor="#c822ff"></stop></linearGradient><path fill="url(#cX29ZNhDlWZrvi4huKePza_79062_gr1)" d="M52,8H12c-1.654,0-3,1.346-3,3v31c0,1.654,1.346,3,3,3h14v2h-9 c-0.297,0-0.578,0.132-0.769,0.36l-5,6c-0.248,0.298-0.302,0.713-0.137,1.064C11.259,54.775,11.612,55,12,55h40 c0.388,0,0.741-0.225,0.905-0.576c0.165-0.352,0.111-0.767-0.137-1.064l-5-6C47.578,47.132,47.297,47,47,47h-9v-2h14 c1.654,0,3-1.346,3-3V11C55,9.346,53.654,8,52,8z M46.531,49l3.334,4h-35.73l3.334-4H26v2h12v-2H46.531z M36,49h-8v-4h8V49z M53,42 c0,0.551-0.448,1-1,1H38H26H12c-0.552,0-1-0.449-1-1V11c0-0.551,0.448-1,1-1h40c0.552,0,1,0.449,1,1V42z"></path><linearGradient id="cX29ZNhDlWZrvi4huKePzb_79062_gr2" x1="32" x2="32" y1="8.375" y2="54.627" gradientUnits="userSpaceOnUse" spreadMethod="reflect"><stop offset="0" stopColor="#1a6dff"></stop><stop offset="1" stopColor="#c822ff"></stop></linearGradient><path fill="url(#cX29ZNhDlWZrvi4huKePzb_79062_gr2)" d="M13,41h38V12H13V41z M15,14h34v25H15V14z"></path><linearGradient id="cX29ZNhDlWZrvi4huKePzc_79062_gr3" x1="22.678" x2="22.678" y1="17.314" y2="35.685" gradientUnits="userSpaceOnUse" spreadMethod="reflect"><stop offset="0" stopColor="#6dc7ff"></stop><stop offset="1" stopColor="#e6abff"></stop></linearGradient><path fill="url(#cX29ZNhDlWZrvi4huKePzc_79062_gr3)" d="M26.271 17.314L17.627 26.5 26.271 35.686 27.729 34.314 20.373 26.5 27.729 18.686z"></path><linearGradient id="cX29ZNhDlWZrvi4huKePzd_79062_gr4" x1="41.322" x2="41.322" y1="17.314" y2="35.685" gradientUnits="userSpaceOnUse" spreadMethod="reflect"><stop offset="0" stopColor="#6dc7ff"></stop><stop offset="1" stopColor="#e6abff"></stop></linearGradient><path fill="url(#cX29ZNhDlWZrvi4huKePzd_79062_gr4)" d="M36.271 18.686L43.627 26.5 36.271 34.314 37.729 35.686 46.373 26.5 37.729 17.314z"></path>
    </svg>
);
...
const svg_grado= (
    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-school" width="44" height="44" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#2c3e50" fill="none" strokeLinecap="round" strokeLinejoin="round">
    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
const svg_udemy= (
    <svg viewBox="0 0 412.77 799.91" xmlns="http://www.w3.org/2000/svg" width="1290" height="2500">
...
const svg_link= (
<svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-share-2" width="44" height="44" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#2c3e50" fill="none" strokeLinecap="round" strokeLinejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
const svg_apellido= (
    ...
    const svg_dropdown= (
    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevron-down" width="44" height="44" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#FFFFFF" fill="none" strokeLinecap="round" strokeLinejoin="round">
        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
        <path d="M6 9l6 6l6 -6" />
    </svg>
        );
    ...
    const svg_suma= (
    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-circle-plus" width="44" height="44" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#2c3e50" fill="none" strokeLinecap="round" strokeLinejoin="round">
    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
    ...
    const svg_check2= (
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-discount-check-filled" width="44" height="44" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#2c3e50" fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
            <path d="M12.01 2.011a3.2 3.2 0 0 1 2.113 .797l.154 .145l.698 .698a1.2 1.2 0 0 0 .71 .341l.135 .008h1a3.2 3.2 0 0 1 3.195 3.018l.005 .182v1c0 .27 .092 .533 .258 .743l.09 .1l.697 .698a3.2 3.2 0 0 1 .147 4.382l-.145 .154l-.698 .698a1.2 1.2 0 0 0 -.341 .71l-.008 .135v1a3.2 3.2 0 0 1 -3.018 3.195l-.182 .005h-1a1.2 1.2 0 0 0 -.743 .258l-.1 .09l-.698 .697a3.2 3.2 0 0 1 -4.382 .147l-.154 -.145l-.698 -.698a1.2 1.2 0 0 0 -.71 -.341l-.135 -.008h-1a3.2 3.2 0 0 1 -3.195 -3.018l-.005 -.182v-1a1.2 1.2 0 0 0 -.258 -.743l-.09 -.1l-.697 -.698a3.2 3.2 0 0 1 -.147 -4.382l.145 -.154l.698 -.698a1.2 1.2 0 0 0 .341 -.71l.008 -.135v-1l.005 -.182a3.2 3.2 0 0 1 3.013 -3.013l.182 -.005h1a1.2 1.2 0 0 0 .743 -.258l.1 -.09l.698 -.697a3.2 3.2 0 0 1 2.269 -.944zm3.697 7.282a1 1 0 0 0 -1.414 0l-3.293 3.292l-1.293 -1.292l-.094 -.083a1 1 0 0 0 -1.32 1.497l2 2l.094 .083a1 1 0 0 0 1.32 -.083l4 -4l.083 -.094a1 1 0 0 0 -.083 -1.32z" strokeWidth="0" fill="#09BE00" />
        </svg>
    );

    const svg_flecha_arriba= (
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-arrow-big-up-lines-filled" width="44" height="44" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#2c3e50" fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
            <path d="M10.586 3l-6.586 6.586a2 2 0 0 0 -.434 2.18l.068 .145a2 2 0 0 0 1.78 1.089h2.586v2a1 1 0 0 0 1 1h6l.117 -.007a1 1 0 0 0 .883 -.993l-.001 -2h2.587a2 2 0 0 0 1.414 -3.414l-6.586 -6.586a2 2 0 0 0 -2.828 0z" strokeWidth="0" fill="currentColor" />
            <path d="M15 20a1 1 0 0 1 .117 1.993l-.117 .007h-6a1 1 0 0 1 -.117 -1.993l.117 -.007h6z" strokeWidth="0" fill="currentColor" />
            <path d="M15 17a1 1 0 0 1 .117 1.993l-.117 .007h-6a1 1 0 0 1 -.117 -1.993l.117 -.007h6z" strokeWidth="0" fill="currentColor" />
        </svg>
    );

    const svg_flecha_abajo= (
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-arrow-big-down-lines-filled" width="44" height="44" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#2c3e50" fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
            <path d="M9 8l-.117 .007a1 1 0 0 0 -.883 .993v1.999l-2.586 .001a2 2 0 0 0 -1.414 3.414l6.586 6.586a2 2 0 0 0 2.828 0l6.586 -6.586a2 2 0 0 0 .434 -2.18l-.068 -.145a2 2 0 0 0 -1.78 -1.089l-2.586 -.001v-1.999a1 1 0 0 0 -1 -1h-6z" strokeWidth="0" fill="currentColor" />
            <path d="M15 2a1 1 0 0 1 .117 1.993l-.117 .007h-6a1 1 0 0 1 -.117 -1.993l.117 -.007h6z" strokeWidth="0" fill="currentColor" />
            <path d="M15 5a1 1 0 0 1 .117 1.993l-.117 .007h-6a1 1 0 0 1 -.117 -1.993l.117 -.007h6z" strokeWidth="0" fill="currentColor" />
        </svg>
    );
    ...
    switch (iconName) {
        ...
        case 'suma':
            return svg_suma;
        case 'flecha_arriba':
            return svg_flecha_arriba;
        case 'flecha_abajo':
            return svg_flecha_abajo;
        case '':
            return null;
        default:
            return svg_error; 
